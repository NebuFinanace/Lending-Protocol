 ...
 * @author Compound
 */
abstract contract CErc20 is NToken, CErc20Interface, CCapableDelegateInterface {
    /**
     ...
     */
    function sweepToken(EIP20NonStandardInterface token) public override {
     ...
     */
    function gulp() external nonReentrant override {
    ...
    function validateFlashloanToken(address token) view internal override {
