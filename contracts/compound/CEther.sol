...
contract CEther is NToken {
    ...
    function validateFlashloanToken(address) view internal override virtual {
        require(false, "Not support");
    }

    function isNativeToken() override public pure returns (bool) {
        return true;
    }
}
