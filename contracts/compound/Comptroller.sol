 ...
 * @author Compound
 */
abstract contract Comptroller is ComptrollerV3Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
     ...
     */
    function redeemVerify(address cToken, address redeemer, uint redeemAmount, uint redeemTokens) external override virtual {
    ...
    function repayBorrowAllowed(
        ...
        address payer,
        address borrower,
        uint repayAmount) public override virtual returns (uint) {
        // Shh - currently unused
        payer;
        borrower;
        repayAmount;
    ...
    function seizeAllowed(
        ...
        address liquidator,
        address borrower,
        uint seizeTokens) public override virtual returns (uint) {
    ...
    function getHypotheticalAccountLiquidityInternal(
        ...
        CToken cTokenModify,
        uint redeemTokens,
        uint borrowAmount) internal view virtual returns (Error, uint, uint);
     ...
     */
    function liquidateCalculateSeizeTokens(address cTokenBorrowed, address cTokenCollateral, uint actualRepayAmount) external view override returns (uint, uint) {
    ...
    function getLiquidationIncentive(address cToken) public view override returns (uint) {
     ...
     */
    function updateCompSupplyIndex(address cToken) internal virtual;

    /**
     * @notice Accrue COMP to the market by updating the borrow index
     * @param cToken The market whose borrow index to update
     */
    function updateCompBorrowIndex(address cToken, Exp memory marketBorrowIndex) internal virtual;
