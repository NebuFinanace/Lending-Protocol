...
abstract contract ComptrollerInterface {
    ...
    function getLiquidationIncentive(address cTokenCollateral) public view virtual returns (uint);

    function safetyGuardian() external view virtual returns (address);
}
