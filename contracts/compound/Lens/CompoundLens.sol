...
contract CompoundLens {
    ...
    function cTokenMetadataExpand(NToken cToken) public returns (
        uint collateralFactorMantissa,
        uint exchangeRateCurrent,
        uint supplyRatePerBlock,
        uint borrowRatePerBlock,
    ...
    function cTokenMetadata(NToken cToken) public returns (CTokenMetadata memory) {
    ...
    function cTokenMetadataAll(NToken[] calldata cTokens) external returns (CTokenMetadata[] memory) {
    ...
    function cTokenBalances(NToken cToken, address payable account) public returns (CTokenBalances memory) {
    ...
    function cTokenBalancesAll(NToken[] calldata cTokens, address payable account) external returns (CTokenBalances[] memory) {
        uint cTokenCount = cTokens.length;
